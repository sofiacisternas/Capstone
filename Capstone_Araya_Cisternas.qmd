...
Se puede observar que la creencia sobre la eficacia del voto (P26ST) es la variable más relevante entre todas las seleccionadas. En este sentido, entre quienes creen que su voto puede cambiar el futuro muestran un nivel de apoyo más alto, reforzándose aún más si no perciben que el país está retorcediendo (P2ST) y si no tienen altas percepciones de corrupción (P54N). 
...
Dentro de las 14 variables consideradas, la que que ejerce mayor influencia en el nivel de apoyo a la democracia de las personas es la percepción de influencia del voto en el futuro. Es decir, las personas que sienten que la manera en la cual se vota si puede generar un cambio tienen mayor probabilidad de presentar un alto nivel de apoyo a la democracia. A esta variable se suman otras relevantes, como la percepción de la situación del país, la percepción de corrupción y, con menor importancia relativa, el sexo, la clase social percibida y los espacios en los cuales se expresa la opinión (familia, amigos, manifestaciones, redes sociales, o si no las expresan).

En este sentido, quienes muestran un alto nivel de apoyo a la democracia consideran que la manera en la que se vota si puede generar un cambio a futuro, tienen una mejor percepción de la situación de país (progesando o estancado) y no perciben nivel de corrupción extremadamente altos.

Para futuras mejoras y continuidades del proyecto, se recomienda incorporar variables adicionales que permitan una medición más precisa del nivel de apoyo a la democracia, así como analizar más indicadores de participación política, percepciones cívicas e institucionales y sociodemográficas que aporten a una caracterización más completa de las personas según su nivel de apoyo. Finalmente, sería interensante aplicar el modelo a las bases de datos de otros países analizados por Latinobarómetro, con el propósito de comparar patrones y características de apoyo democrático en la región.
